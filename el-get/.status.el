((abbrev-complete status "removed" recipe nil)
 ...
 (browse-kill-ring status "removed" recipe nil)
 ...
 (color-theme-railscasts status "removed" recipe nil)
 (column-marker status "removed" recipe nil)
 (csharp-mode status "removed" recipe nil)
 (css-mode status "removed" recipe nil)
 (csv-mode status "removed" recipe nil)
 (dsvn status "removed" recipe nil)
 ...
 (helm-mercurial-queue status "installed" recipe
                       (:name helm-mercurial-queue :type git :url "https://github.com/emacs-helm/helm-mercurial-queue"))
 ...
 (php-mode status "removed" recipe nil)
 ...
 (visual-basic-mode status "installed" recipe
                    (:name visual-basic-mode :auto-generated t :type emacswiki :description "A mode for editing Visual Basic programs." :website "https://raw.github.com/emacsmirror/emacswiki.org/master/visual-basic-mode.el"))
 (wdired status "installed" recipe
 ...
 (wgrep status "removed" recipe nil)
